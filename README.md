...
- отличия хешей от массивов
- задача: создаем словарик
- задача: переделываем “однорукого бандита” с использованием хешей
...
- повторяем хэши
/*Правильным вариантом является «хеш» согласно современным нормам русского языка, хотя вариант «хэш» также широко используется и допустим, особенно в технической литературе.   */
